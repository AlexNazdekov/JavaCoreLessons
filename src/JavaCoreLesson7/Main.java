...
public class Main {
    private final static String WeatherURL =  "http://dataservice.accuweather.com/forecasts/v1/daily/5day/290826"; // URL для запроса погоды на 5 дней в Набережных Челнах.
    private final static String API_KEY = "?apikey=GLrOe7Yv7QGZg6GAQ1OuqnkQYdDqFteE"; // API ключ для запроса. См. гайд, как его получить и вставить.
